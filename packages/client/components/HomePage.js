    ...
    <div className="home-container">
      ...
      <div className="form-container">
        <div className="clone-explanation">
          <h3>Hello there!</h3>
          <p>
            This is a Twitter clone, this app is created with the sole purpose of studying and provide users with technical insight on how to develop full fledged apps. If you have any inquire or find any issues, please open a ticket at{' '}
            <a href="https://github.com/richardba/node_twitter_clone/issues">
              here
            </a>
            . Source code available at{' '}
            <a href="https://github.com/richardba/node_twitter_clone">
              here
            </a>
            .
          </p>
